  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard" class="brand-link">
      <img src="view/presentacion/dist/img/AdminLTELogo.png" alt="OlimpicaRGV Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">OlimpicaRGV</span>
    </a>
